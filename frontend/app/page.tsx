...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#030712] text-white flex relative overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className="w-24 min-h-screen border-r border-white/10 bg-black/40 backdrop-blur-xl flex flex-col items-center py-8 relative z-10">
        <div className="w-14 h-14 rounded-2xl bg-cyan-500/20 flex items-center justify-center mb-12">
          <Sparkles className="text-cyan-300" />
        </div>

        <div className="flex flex-col gap-8 text-zinc-400">
          <ImageIcon className="hover:text-white transition cursor-pointer" />
          <Video className="hover:text-white transition cursor-pointer" />
          <Workflow className="hover:text-white transition cursor-pointer" />
          <Settings className="hover:text-white transition cursor-pointer" />
        </div>
      </aside>

      {/* Main Content */}
      <section className="flex-1 p-12 pt-36 relative z-10">
        <div className="mb-20">
